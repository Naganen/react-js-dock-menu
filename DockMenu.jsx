  ...
  return (
    <>
      <style>{`
        ...
        .notch { width: 45px; height: 5px; background: #adb5bd; border-radius: 10px; margin-bottom: 12px; opacity: 0.6; }
        .dock-container {
        ...
        .dock-item {
          ...
          align-items: center; min-width: 75px; text-decoration: none !important; cursor: pointer; color: #333;
        }
        .dock-item:hover { background: rgba(0,0,0,0.06); transform: translateY(-4px); color: #000; }
        .icon-box { font-size: 24px; height: 35px; display: flex; align-items: center; justify-content: center; }
        .item-text { font-size: 10px; font-weight: 500; margin-top: 4px; text-align: center; }
